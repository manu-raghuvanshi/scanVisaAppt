...
while True:
    ...
    for tr in soup.find_all("tr"):
        if "data-index" in tr.attrs:
            if tr["data-index"] == "9":
                if tr.contents[1].get_text() == "B1/B2 (Regular)" and tr.contents[0].get_text() == "NEW DELHI VAC":
                    if ("Jan" in tr.contents[2].get_text() or "Feb" in tr.contents[2].get_text()
                            or "Mar" in tr.contents[2].get_text() or "Apr" in tr.contents[2].get_text()):
                        message = {
